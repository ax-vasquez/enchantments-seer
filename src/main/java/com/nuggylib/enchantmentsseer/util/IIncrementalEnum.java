package com.nuggylib.enchantmentsseer.util;

import javax.annotation.Nonnull;
import java.util.function.Predicate;

/**
 * Shamelessly-copies from the Mekanism codebase; all credit goes to them
 *
 * @param <TYPE>
 * @see "https://github.com/mekanism/Mekanism/blob/v10.1/src/api/java/mekanism/api/IIncrementalEnum.java"
 */
