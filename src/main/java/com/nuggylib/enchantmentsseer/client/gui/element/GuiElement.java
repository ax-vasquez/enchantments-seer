...
public abstract class GuiElement extends Widget implements IFancyFontRenderer {
    ...
    public static final ResourceLocation WARNING_BACKGROUND_TEXTURE = MekanismUtils.getResource(ExistingFileHelper.ResourceType.GUI, "warning_background.png");
    public static final ResourceLocation WARNING_TEXTURE = MekanismUtils.getResource(ExistingFileHelper.ResourceType.GUI, "warning.png");
