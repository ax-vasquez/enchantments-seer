 ...
 *
 * The {@link VirtualSlotContainerScreen} class extends the Vanilla {@link ContainerScreen} class and overrides much
 * of the base behavior.
 *
 * Note that, in order to override the logic in this class, we had to enable Access Transformers, which modify the
 * access levels of various things within the Minecraft Vanilla codebase, so that they can be directly worked with.
 *
 * This class <b>is not</b> meant to be directly-subclassed by GUI classes. Instead, this class is extended by
 * {@link GuiEnchantmentsSeer}, which provides further logic to aid in the construction of GUIs.
 *
 * @param <CONTAINER>   The {@link Container} class underlying the container screen
 * @see "https://mcforge.readthedocs.io/en/1.16.x/advanced/accesstransformers/"
 */
public abstract class VirtualSlotContainerScreen<CONTAINER extends Container> extends ContainerScreen<CONTAINER> {

    public VirtualSlotContainerScreen(CONTAINER container, PlayerInventory inv, ITextComponent titleIn) {
