...
import com.nuggylib.enchantmentsseer.client.gui.GuiElement;
import com.nuggylib.enchantmentsseer.client.gui.GuiElement.IHoverable;
...
public class EnchantmentsSeerImageButton extends EnchantmentsSeerButton {
    ...
    public EnchantmentsSeerImageButton(IGuiWrapper gui, int x, int y, int size, ResourceLocation resource, Runnable onPress, IHoverable onHover) {
    ...
    public EnchantmentsSeerImageButton(IGuiWrapper gui, int x, int y, int size, int textureSize, ResourceLocation resource, Runnable onPress, IHoverable onHover) {
    ...
    public EnchantmentsSeerImageButton(IGuiWrapper gui, int x, int y, int width, int height, int textureWidth, int textureHeight, ResourceLocation resource, Runnable onPress, IHoverable onHover) {
