...
import com.nuggylib.enchantmentsseer.common.ILangEntry;
...
public class GuiElement extends Widget implements IFancyFontRenderer {
    ...
    protected ResourceLocation getButtonLocation(String name) {
        return EnchantmentsSeerUtils.getResource(ResourceType.GUI_BUTTON, name + ".png");
    }
    ...
    public enum ButtonBackground {
        DEFAULT(EnchantmentsSeerUtils.getResource(ResourceType.GUI, "button.png")),
        NONE(null);
