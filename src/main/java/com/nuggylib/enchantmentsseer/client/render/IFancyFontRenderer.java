...
import com.nuggylib.enchantmentsseer.client.SpecialColors;
...
/**
 * A utility interface to provide convenience methods that assist in rendering text in GUIs.
 *
 * Shamelessly-copied from the Mekanism codebase (because they are awesome and their stuff works <3)
 *
 * @see "https://github.com/mekanism/Mekanism/blob/v10.1/src/main/java/mekanism/client/render/IFancyFontRenderer.java"
 */
