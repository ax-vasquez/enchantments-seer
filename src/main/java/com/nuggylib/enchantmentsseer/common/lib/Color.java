...
import com.nuggylib.enchantmentsseer.common.utils.StatUtils;

import java.util.Objects;

/**
 * A utility class for handling colors when rendering
 *
 * Shamelessly-copied from the Mekanism codebase (because they are awesome and their stuff works <3)
 *
 * @see "https://github.com/mekanism/Mekanism/blob/v10.1/src/main/java/mekanism/common/lib/Color.java"
 */
public class Color {
