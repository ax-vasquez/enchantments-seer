 ...
 *
 * A double deferred register used to couple a block with its corresponding item. Don't use this for blocks that don't
 * have items, or items that don't have blocks.
 *
 * @see "https://github.com/mekanism/Mekanism/blob/v10.1/src/main/java/mekanism/common/registration/DoubleDeferredRegister.java"
 */
