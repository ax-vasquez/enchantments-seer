...
import com.nuggylib.enchantmentsseer.common.NBTConstants;
import com.nuggylib.enchantmentsseer.common.NBTUtils;
...
import com.nuggylib.enchantmentsseer.common.util.annotations.NonNull;
...
public class BasicInventorySlot implements IInventorySlot {
    ...
    public static BasicInventorySlot at(Predicate<@NonNull ItemStack> validator, int x, int y) {
    ...
    protected BasicInventorySlot(Predicate<@NonNull ItemStack> validator, int x, int y) {
        this(DEFAULT_LIMIT, validator, x, y);
    }

    protected BasicInventorySlot(int limit, Predicate<@NonNull ItemStack> validator, int x, int y) {
        this.limit = limit;
    ...
    public void deserializeNBT(CompoundNBT nbt) {
        ...
        if (nbt.contains(NBTConstants.ITEM, Constants.NBT.TAG_COMPOUND)) {
