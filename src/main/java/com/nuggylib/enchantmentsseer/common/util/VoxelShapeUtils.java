 ...
 *
 * @see "https://github.com/mekanism/Mekanism/blob/v10.1/src/main/java/mekanism/common/util/VoxelShapeUtils.java"
 */
public final class VoxelShapeUtils {
    ...
    public static void print(double x1, double y1, double z1, double x2, double y2, double z2) {
        EnchantmentsSeer.logger.info("box({}, {}, {}, {}, {}, {}),", Math.min(x1, x2), Math.min(y1, y2), Math.min(z1, z2),
    ...
    public static void printSimplified(String name, VoxelShape shape) {
        EnchantmentsSeer.logger.info("Simplified: {}", name);
